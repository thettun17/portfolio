...
export default function About() {
  return (
    <>
      ...
      <div className="flex gap-5 desktop:flex-row">
        <div className="desktop:w-2/6 custom-shadow rounded-lg p-5 flex flex-row gap-x-3 border-secondaryColor">
        ...
        <div className="desktop:w-2/6 custom-shadow rounded-lg p-5 flex flex-row gap-x-3">
          <div className="flex-none w-0.5/3">
